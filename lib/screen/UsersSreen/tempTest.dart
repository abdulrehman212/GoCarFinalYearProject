...
//   Future<void> checkandupdateFare(int noOfSeats, String docId) async {
...
//       if (noOfSeats == 3) {
//         setState(() {
//           user1fare = distanceData * basefare;
//           fare = user1fare;
//         });

//         await saveFareAndKilometers(docId, fare, distanceData);
...
//         var max1;
//         if (snapshot.exists) {
//           var userDistanceArray = snapshot.get('usersKilometere');

//           user1distance = userDistanceArray[0];

//           // user1distance = snapshot.get('user1distance');
//           if (user1distance > distanceData) {
//             setState(() {
//               max1 = user1distance;
//             });
//           } else {
...
//           double totalDistance = user1distance + distanceData;

//           setState(() {
//             user1fare = (user1distance / totalDistance) * value1;
//             user2fare = (distanceData / totalDistance) * value1;
//             fare = user2fare;
//           });

//           dynamic arrayData = snapshot.get('usersFare');

//           if (arrayData is List && arrayData.isNotEmpty) {
//             arrayData[0] = user1fare;

//             await documentRef.update({'usersFare': arrayData});
//           }
...
//         var max2;
//         if (snapshot.exists) {
//           var userDistanceArray1 = snapshot.get('usersKilometere');

//           user1distance = userDistanceArray1[0];
//           user2distance = userDistanceArray1[1];
//           // user1distance = snapshot.get('user1distance');
//           // user2distance = snapshot.get('user2distance');
//           if (user2distance > user1distance && user2distance > distanceData) {
//             setState(() {
//               max2 = user2distance;
//             });
...
//           double totalDistance = user1distance + user2distance + distanceData;

//           setState(() {
//             user1fare = (user1distance / totalDistance) * value2;
//             user2fare = (user2distance / totalDistance) * value2;
//             user3fare = (distanceData / totalDistance) * value2;
//             fare = user3fare;
//           });

//           dynamic arrayData1 = snapshot.get('usersFare');

//           if (arrayData1 is List && arrayData1.isNotEmpty) {
//             arrayData1[0] = user1fare;
//             arrayData1[1] = user2fare;

//             await documentRef.update({'usersFare': arrayData1});
//           }
...
//   Future<void> saveFareAndKilometers(
//       String rideId, List userFare, List userKilometer) async {
//     try {
...
//           'usersFare': FieldValue.arrayUnion(userFare),
//           'usersKilometere': FieldValue.arrayUnion(userKilometer),
//         });
//       } else {
...
//   Future<String> saveUserInfoOnBooking(
//       String rideId, List uid, List username, List phone, List email) async {
//     try {
//       final snapshot = await FirebaseFirestore.instance
//           .collection('Rides')
...
//   Future<String> getandupdatedSeats(String rideId, String userEmail) async {
//     try {
...
//       List<dynamic> passengers = data['user_email'] ?? [];
//       if (passengers.contains(userEmail)) {
...
//                                                 final phone = userInfo[1];
//                                                 final email = userInfo[2];
...
//                                                   );
//                                                 } else {
//                                                   if (await getandupdatedSeats(
//                                                           rideList[index]['id'],
//                                                           email) ==
//                                                       'success') {
//                                                     var noOfSEAT = rideList[
//                                                             index][
//                                                         'NumberOfSeatsAvailable'];
...
//                                                         noOfSEAT,
//                                                         rideId);
//                                                     String temprideStatus =
//                                                         await saveUserInfoOnBooking(
//                                                             rideList[index]
//                                                                 ['id'],
//                                                             [newUser.uid],
//                                                             [username],
...
//                                                         'success') {
//                                                       //show dailog
//                                                     } else if (temprideStatus ==
//                                                         'User already booked.') {
//                                                       //show rideAlreadyBooked
//                                                       showDialog(
//                                                         context: context,
//                                                         builder: (BuildContext
//                                                             context12) {
...
//                                                                 Text('Error !'),
//                                                             content: Text(
//                                                                 'A problem is occured! You Cannot book this ride.'),
//                                                             actions: [
//                                                               TextButton(
//                                                                 onPressed:
//                                                                     () async {
...
//                                                       );
//                                                     }
//                                                   } else if (await getandupdatedSeats(
//                                                           rideList[index]['id'],
//                                                           email) ==
//                                                       'failed') {
//                                                     showDialog(
...
//       BuildContext context, int noOfSeats, String docId) {
...
//                     //   ),
//                     // );
//                     await calculateDistance(source, destination);
//                     await checkandupdateFare(noOfSeats, docId);
//                     // Navigator.pop(context);
